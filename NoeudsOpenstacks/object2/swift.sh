crudini --set /etc/swift/account-server.conf DEFAULT bind_ip 10.0.0.52
...
crudini --set /etc/swift/container-server.conf DEFAULT bind_ip 10.0.0.52
...
crudini --set /etc/swift/object-server.conf DEFAULT bind_ip 10.0.0.52
